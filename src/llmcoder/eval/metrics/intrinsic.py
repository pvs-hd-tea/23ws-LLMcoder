...
def total_tokens_generated_score(llmcoder_result: dict) -> int:
    """
    Compute the number of tokens generated by llmcoder.
    ...
    -------
    int
        The number of tokens generated by llmcoder.
    """
    return llmcoder_result['n_tokens_generated']
